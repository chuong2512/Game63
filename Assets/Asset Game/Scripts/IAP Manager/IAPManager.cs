...
public class Key
{
    public const string PACK1 = "game63_pack1";
    public const string PACK2 = "game63_pack2";
    public const string PACK3 = "game63_pack3";
    public const string PACK4 = "game63_pack4";


    public const string PACK1_REGISTER = "register_game63_pack1";
    public const string PACK2_REGISTER = "register_game63_pack2";
    public const string PACK3_REGISTER = "register_game63_pack3";
    public const string PACK4_REGISTER = "register_game63_pack4";
    public const string PACK5_REGISTER = "register_game63_pack5";
}
